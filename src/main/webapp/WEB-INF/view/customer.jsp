...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
 ...
 <!-- link to userModal css file -->
 <link rel="stylesheet" href="userInfoModalStyle.css">

 <!-- link to the CheckoutModal css file -->
 <link rel="stylesheet" href="CheckoutModalStyle.css">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php if (!empty($userDetails)): ?>
                        <p><strong>Name:</strong> <?php echo htmlspecialchars($userDetails['fullname']); ?></p>
...
<div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('1', 'Baguette Bread', 'Savour the taste of French sticks; made from flour, water, yeast and salt!')">
            Select
        </button>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('2', 'Brioche Bread', 'Unique French bread made with butter and eggs!')">
            Select
        </button>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('3', 'Ciabatta Bread', 'Perfect for paninis and sandwiches; consists of water, yeast, salt and flour!')">
            Select
        </button>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('4', 'Multigrain Bread', 'Specially for fitness freaks-contains oats, barley, flax, millet, and more!')">
            Select
        </button>
    </div>
</div>
 ...
 <div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('5', 'Whole Wheat', 'Nutritious and has more fibre than regular bread!')">
            Select
        </button>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('6', 'Lavash Bread', 'Low in fat and made with flour, salt and water!')">
            Select
        </button>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('7', 'Thin Bread', 'Tasty jewish bread made from wheat, barley, rice, oats and spelt!')">
            Select
        </button>
    </div>
</div>
 ...
 <div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('8', 'Naan Bread', 'Delicious naan that uses yogurt as its main ingredient!')">
            Select
        </button>
    </div>
</div>
 ...
 <div class="card">
    ...
    <div class="card-action">
        <button class="btn btn-primary" onclick="openModal('9', 'Tortilla', 'Soft, thin flatbreads utilised in various Mexican dishes, wraps and tacos!')">
            Select
        </button>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="font-size: 20px; margin-top: 5px;" ><strong>Total Price: </strong><span id="totalPrice">0</span> IQD</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<!-- Footer -->
<div id="footer" style="margin-top: 40px; margin-bottom 20px;" >

    <!-- Phone Numbers -->
    <div class="footer__contact">
        <i>+964 750 141 8006</i>
        <br>
        <i>+964 771 152 8011</i>
    </div>
